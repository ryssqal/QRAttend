...
<body>
    <div class="container">
        ...
        <div class="left-section">
            ...
            <p class="welcome-subtitle">Don’t Have an Account?</p>
            <a href="/register" class="btn-outline" style="text-decoration: none; display: inline-block;">Register</a>
        </div>
